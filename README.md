...
- **Documentation**: See [`task-1_TODO/README.md`](./task-1_TODO/README.md) for startup and details.
...
- **Documentation**: See [`task-3_Docker/README.md`](./task-3_Docker/README.md) for deployment steps.
...
- **Documentation**: See [`task-4_Redux/README.md`](./task-4_Redux/README.md) for implementation details.
...
> **Note**: For security reasons, the `.env` configuration files are **not included** in this repository. Please refer to the attached email/submission for the required `.env` files and place them in their respective directories.
...
2.  **Navigate to a Task**
    ...
    ```bash
    cd task-4_Redux/  # Example: To run the Redux application
    ```
